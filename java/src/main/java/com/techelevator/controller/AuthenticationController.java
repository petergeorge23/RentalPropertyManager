...
public class AuthenticationController {
    ...
    public ResponseEntity<LoginResponseDto> login(@Valid @RequestBody LoginDto loginDto) {
        ...
        if (user.isActivated()) {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Your account must be approved in order to sign in.");
        }
    ...
    @RequestMapping(path = "/renters", method = RequestMethod.GET)
